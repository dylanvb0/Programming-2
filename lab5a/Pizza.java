...
public class Pizza {
	...
	/**
	 * Precondition: pizza is a properly initialized pizza object
	 * Postcondition: new Pizza object with same fields as passed pizza object (copy)
	 * @param pizza
	 */
	public Pizza(Pizza pizza){
		setSize(pizza.size);
		setCheeseTopping(pizza.cheeseTopping);
		setPepperoniTopping(pizza.pepperoniTopping);
		setHamTopping(pizza.hamTopping);
	}
